...
if (!serviceWorker.includes("const CACHE_NAME = 'taxi-uspeh-v35-dispatcher-service-details'")) failures.push('service-worker.js: dispatcher service-details cache version was not updated');
