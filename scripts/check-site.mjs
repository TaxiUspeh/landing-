...
if (!serviceWorker.includes("const CACHE_NAME = 'taxi-uspeh-v70-driver-filter-theme'")) failures.push('service-worker.js: map booking cache version was not updated');
