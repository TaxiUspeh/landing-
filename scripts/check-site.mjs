...
if (!serviceWorker.includes("const CACHE_NAME = 'taxi-uspeh-v71-order-time'")) failures.push('service-worker.js: map booking cache version was not updated');
