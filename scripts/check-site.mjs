...
if (!serviceWorker.includes("const CACHE_NAME = 'taxi-uspeh-v38-driver-balance-summary'")) failures.push('service-worker.js: driver-balance-summary cache version was not updated');
