...
if (!serviceWorker.includes("const CACHE_NAME = 'taxi-uspeh-v39-dispatcher-order-completion'")) failures.push('service-worker.js: dispatcher-order-completion cache version was not updated');
