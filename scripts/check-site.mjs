...
if (!serviceWorker.includes("const CACHE_NAME = 'taxi-uspeh-v37-online-delivery'")) failures.push('service-worker.js: online-delivery cache version was not updated');
