...
if (!serviceWorker.includes("const CACHE_NAME = 'taxi-uspeh-v67-customer-price'")) failures.push('service-worker.js: map booking cache version was not updated');
...
for (const expected of [
  ...
  "'./driver-portal.js?v=67'",
  "'./drivers.webmanifest'",
  "'./dispatcher.html'",
  "'./dispatcher.js?v=67'",
  "'./firebase-config.js'",
  "'./client-orders.js?v=67'",
  "'./client-home.js?v=60'",
