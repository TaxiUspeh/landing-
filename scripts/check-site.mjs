...
if (!serviceWorker.includes("const CACHE_NAME = 'taxi-uspeh-v64-delivery-validation'")) failures.push('service-worker.js: map booking cache version was not updated');
