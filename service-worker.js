const CACHE_NAME = 'taxi-uspeh-v67-customer-price';
const APP_SHELL = [
  './',
  './driver-finance.js?v=60',
  './driver-finance-controls.js?v=60',
  './index.html',
  './customer-pricing.js?v=67',
  './customer-price-control.js?v=67',
