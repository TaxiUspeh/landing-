import { serviceEnabled, serviceDirection } from './functions/driver-services.mjs?v=74';
...
export function driverCanServeOrder(driver, order = {}) {
  ...
  if (order.serviceType === 'soberDriver' && driver.soberDriverEnabled !== true) return false;
